...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      if($image_size > 2000000){
         ...
         $insert_product = $conn->prepare("INSERT INTO `products`(name, price, image, catid) VALUES(?,?,?,?)");
         $insert_product->execute([$name, $price, $image, $catid]);
...
<section class="show-products" style="padding-top: 0;">
   <div class="box-container">
      <?php
      $show_products = $conn->prepare("SELECT id, name, price, image, catid FROM `products`");
